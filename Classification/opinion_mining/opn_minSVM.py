...
tfidf = TfidfVectorizer(strip_accents=None,lowercase=False,preprocessor=None, ngram_range=(2,2), tokenizer=tokenizer_porter)
...
lr_tfidf = Pipeline([('vect', tfidf),('clf', SVC(random_state=1, C = 0.1, kernel= 'linear'))])
